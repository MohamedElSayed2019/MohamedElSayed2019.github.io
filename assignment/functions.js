...
console.log("\n");
console.log("Expected output of findLongestWord([okay,mohamed abdelsalam,vowel]) is 5 "+myFunctionTest(5, ()=>findLongestWord("okay","mohamed abdelsalam","vowel")));
console.log("Expected output of findLongestWord([okay,mohamed abdelsalam,vowel]) is 5 "+myFunctionTest(3, ()=>findLongestWord("okay","mohamed abdelsalam","vowel")));

console.log("\n");
console.log("Expected output of filterLongWords(4,[okay,mohamed abdelsalam,vowel]) is [mohamed abdelsalam,vowel] "+myFunctionArrayTest(['mohamed abdelsalam','vowel'], ()=>filterLongWords(4,'okay','mohamed abdelsalam','vowel')));
console.log("Expected output of filterLongWords(4,[okay,mohamed abdelsalam,vowel]) is [mohamed abdelsalam,vowel] "+myFunctionArrayTest(['mohamed abdelsalam'], ()=>filterLongWords(4,'okay','mohamed abdelsalam','vowel')));
